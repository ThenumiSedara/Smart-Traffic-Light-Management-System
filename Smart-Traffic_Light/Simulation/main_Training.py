...
def PrepareConstants():
    ...
    DATA_PATH = 'C:/Users/PC/Downloads/DSGP simulation/RLTrafficSignalControl-master/Simulation/data/'
    ...
    parser.add_argument('-d', '--data_path', help=data_path_descr, type=str,
                        default='C:/Users/PC/Downloads/DSGP simulation/RLTrafficSignalControl-master/Simulation/data/')
